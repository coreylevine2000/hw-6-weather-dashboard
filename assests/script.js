// 
let apiKey = "5121fb99f39893107e74ac676f777219";
...
let searchHistoryEl = $(".citySeached");
...
function renderSearchHistory(cityName) {
    ...
    for (let i = 0; i < searchHistoryArr.length; i++) {
        // We put newListItem in loop because the text of the li element will change
...
function getWeather(desiredCity) {
    ...
    .then(function(uvData) {
        if (JSON.parse(localStorage.getItem("searchHistory")) == null) {
            ...
            // Prevents user from adding the same city to the searchHistory array list more than once
...
//Forcast information to be displayed
